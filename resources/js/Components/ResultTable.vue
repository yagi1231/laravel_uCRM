...
<template>
    <div v-if="props.data.type === 'perDay' || props.data.type === 'perMonth' || props.data.type === 'perYear'"
        ...
        <table class="table-auto w-full text-left whitespace-no-wrap">
            ...
            <tbody>
                <tr v-for="item in data.value" :key="item.date">
    ...
    <div v-if="props.data.type === 'decile'" class="lg:w-2/3 w-full mx-auto overflow-auto">
        <table class="table-auto w-full text-left whitespace-no-wrap">
            <thead>
                <tr>
                    <th
