...
<template>
        ...
        <div class="modal__overlay" tabindex="-1" data-micromodal-close>
            <div class="modal__container w-2/3" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
                <header class="modal__header">
                    ...
                    <button @click="toggleStatus()" tyep="button" class="modal__close" aria-label="Close modal"
                ...
                <footer class="modal__footer">
                    <button @click=" toggleStatus()" tyep="button" class="modal__btn" data-micromodal-close
    ...
    <button type="button" @click="searchCustomers"  class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 mt-3 focus:outline-none hover:bg-indigo-600 rounded text-lg">検索する</button>
</template>
